"""
Train the HeteroGTDDI model on the constructed knowledge graph.
...
def train():
    ...
    model_type = config["model"].get("type", "gt")
    attn_type = config["model"].get("attention_type", "sparse")
    print(f"\n--- Initializing Training for Model: {model_type.upper()} ({attn_type.upper()} Attention) ---")
    ...
    checkpoint_path = f"results/model_checkpoint_{model_type}_{attn_type}.pt"
    metrics_path = f"results/test_metrics_{model_type}_{attn_type}.json"
    per_class_path = f"results/per_class_metrics_{model_type}_{attn_type}.csv"
    ...
    # Test evaluation
    print(f"\n--- Evaluating Best Model on Test Set: {checkpoint_path} ---")
    ...
    print("\n==========================================")
    print(f"Overall Test Set Metrics ({model_type.upper()} - {attn_type.upper()})")
    print("==========================================")
