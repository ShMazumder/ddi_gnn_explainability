...
# Find step 3 code cell
cell_idx = None
for idx, cell in enumerate(nb["cells"]):
    if cell["cell_type"] == "code" and any("process_twosides = build_kg.process_twosides" in line for line in cell["source"]):
        cell_idx = idx
        break
...
if cell_idx is not None:
    ...
    print("Notebook Step 3 updated successfully!")
else:
